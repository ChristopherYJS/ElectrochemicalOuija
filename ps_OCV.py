...
def ocv_parm(board_type, api, ocv_settings):
    ...
    p_duration= make_ecc_parm(api, OCV_parms["duration"], ocv_settings['duration'])
    p_record_dt= make_ecc_parm(api, OCV_parms["record_dt"], ocv_settings['record_dt'])
    p_record_dE= make_ecc_parm(api, OCV_parms["record_dE"], ocv_settings['record_dE'])
    p_erange= make_ecc_parm(api, OCV_parms["E_range"], KBIO.E_RANGE[ocv_settings['e_range']].value)
