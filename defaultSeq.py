...
def build_default_sequence_ui(main_window):
    ...
    main_window.dictChannelTechs[main_window.numCurrentChannel] = {}
    ...
    page1 = main_window._buildTab(CAUI, item1, i_ranges=[])
    main_window.dictChannelTechs[main_window.numCurrentChannel][item1] = page1
    ...
    page2 = main_window._buildTab(LoopUI, item2, i_ranges=[])
    main_window.dictChannelTechs[main_window.numCurrentChannel][item2] = page2
    ...
    page3 = main_window._buildTab(CAUI, item3, i_ranges=[])
    main_window.dictChannelTechs[main_window.numCurrentChannel][item3] = page3
    ...
    page4 = main_window._buildTab(LoopUI, item4, i_ranges=[])
    main_window.dictChannelTechs[main_window.numCurrentChannel][item4] = page4
    ...
    page5 = main_window._buildTab(CAUI, item5, i_ranges=[])
    main_window.dictChannelTechs[main_window.numCurrentChannel][item5] = page5
