...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButtonConnect.setMaximumSize(QSize(60, 50))
        ...
        self.pushButton_ErrorTest = QPushButton(self.frameShortCut)
        self.pushButton_ErrorTest.setObjectName(u"pushButton_ErrorTest")
        sizePolicy1.setHeightForWidth(self.pushButton_ErrorTest.sizePolicy().hasHeightForWidth())
        self.pushButton_ErrorTest.setSizePolicy(sizePolicy1)
        self.pushButton_ErrorTest.setMinimumSize(QSize(40, 40))
        self.pushButton_ErrorTest.setMaximumSize(QSize(60, 50))

        self.horizontalLayout_3.addWidget(self.pushButton_ErrorTest)

        self.pushButton_3 = QPushButton(self.frameShortCut)
        ...
        self.pushButton_5.setMaximumSize(QSize(60, 50))
        ...
        sizePolicy3.setHeightForWidth(self.scrollAreaOption_Techs.sizePolicy().hasHeightForWidth())
        self.scrollAreaOption_Techs.setSizePolicy(sizePolicy3)
        ...
        sizePolicy2.setHeightForWidth(self.treeWidget_Techs.sizePolicy().hasHeightForWidth())
        self.treeWidget_Techs.setSizePolicy(sizePolicy2)
        ...
        sizePolicy5.setHeightForWidth(self.frame_Channels.sizePolicy().hasHeightForWidth())
        self.frame_Channels.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.frame_Tech.sizePolicy().hasHeightForWidth())
        self.frame_Tech.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.pushButton_SingleRun.sizePolicy().hasHeightForWidth())
        self.pushButton_SingleRun.setSizePolicy(sizePolicy5)
        ...
        self.pushButton_StopSingle = QPushButton(self.frame_Tech)
        self.pushButton_StopSingle.setObjectName(u"pushButton_StopSingle")
        sizePolicy5.setHeightForWidth(self.pushButton_StopSingle.sizePolicy().hasHeightForWidth())
        self.pushButton_StopSingle.setSizePolicy(sizePolicy5)
        self.pushButton_StopSingle.setMinimumSize(QSize(40, 40))
        self.pushButton_StopSingle.setMaximumSize(QSize(80, 40))

        self.horizontalLayout.addWidget(self.pushButton_StopSingle)

        self.pushButton_MultiRun = QPushButton(self.frame_Tech)
        self.pushButton_MultiRun.setObjectName(u"pushButton_MultiRun")
        sizePolicy5.setHeightForWidth(self.pushButton_MultiRun.sizePolicy().hasHeightForWidth())
        self.pushButton_MultiRun.setSizePolicy(sizePolicy5)
        ...
        self.pushButton_StopAll = QPushButton(self.frame_Tech)
        self.pushButton_StopAll.setObjectName(u"pushButton_StopAll")
        sizePolicy5.setHeightForWidth(self.pushButton_StopAll.sizePolicy().hasHeightForWidth())
        self.pushButton_StopAll.setSizePolicy(sizePolicy5)
        self.pushButton_StopAll.setMinimumSize(QSize(40, 40))
        self.pushButton_StopAll.setMaximumSize(QSize(80, 40))

        self.horizontalLayout.addWidget(self.pushButton_StopAll)
        ...
        sizePolicy6.setHeightForWidth(self.frame_ps.sizePolicy().hasHeightForWidth())
        self.frame_ps.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.frame_mp.sizePolicy().hasHeightForWidth())
        self.frame_mp.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.frame_log.sizePolicy().hasHeightForWidth())
        self.frame_log.setSizePolicy(sizePolicy6)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_ErrorTest.setText(QCoreApplication.translate("MainWindow", u"Test\n"
"Sequence\n"
"Built", None))
        self.pushButton_3.setText(QCoreApplication.translate("MainWindow", u"Add\n"
"Default\n"
"Sequence", None))
